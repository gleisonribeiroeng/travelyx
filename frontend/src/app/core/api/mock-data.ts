...
export const MOCK_AIRPORTS: AirportOption[] = [
  { id: 'GRU.AIRPORT', iataCode: 'GRU', name: 'Guarulhos International', cityName: 'São Paulo' },
  { id: 'CGH.AIRPORT', iataCode: 'CGH', name: 'Congonhas', cityName: 'São Paulo' },
  { id: 'GIG.AIRPORT', iataCode: 'GIG', name: 'Galeão - Tom Jobim', cityName: 'Rio de Janeiro' },
  { id: 'BSB.AIRPORT', iataCode: 'BSB', name: 'Presidente Juscelino Kubitschek', cityName: 'Brasília' },
  { id: 'CNF.AIRPORT', iataCode: 'CNF', name: 'Tancredo Neves / Confins', cityName: 'Belo Horizonte' },
  // Europe
  { id: 'CDG.AIRPORT', iataCode: 'CDG', name: 'Charles de Gaulle', cityName: 'Paris' },
  { id: 'ORY.AIRPORT', iataCode: 'ORY', name: 'Orly', cityName: 'Paris' },
  { id: 'BRU.AIRPORT', iataCode: 'BRU', name: 'Brussels Airport', cityName: 'Bruxelas' },
  { id: 'CRL.AIRPORT', iataCode: 'CRL', name: 'Brussels South Charleroi', cityName: 'Bruxelas' },
  { id: 'LIS.AIRPORT', iataCode: 'LIS', name: 'Humberto Delgado', cityName: 'Lisboa' },
  { id: 'FCO.AIRPORT', iataCode: 'FCO', name: 'Leonardo da Vinci - Fiumicino', cityName: 'Roma' },
  { id: 'LHR.AIRPORT', iataCode: 'LHR', name: 'Heathrow', cityName: 'Londres' },
  { id: 'AMS.AIRPORT', iataCode: 'AMS', name: 'Schiphol', cityName: 'Amsterdã' },
  { id: 'MAD.AIRPORT', iataCode: 'MAD', name: 'Adolfo Suárez Madrid-Barajas', cityName: 'Madrid' },
];
...
export const MOCK_FLIGHTS: Flight[] = [
  // === GRU → CDG (São Paulo → Paris) ===
  {
    ...
    airline: 'Air France', airlineCode: 'AF', airlineLogo: 'https://pics.avs.io/120/120/AF.png',
    flightNumber: 'AF 457', durationMinutes: 685, stops: 0,
  ...
  },
  {
    ...
    airline: 'LATAM', airlineCode: 'LA', airlineLogo: 'https://pics.avs.io/120/120/LA.png',
    flightNumber: 'LA 8084', durationMinutes: 690, stops: 0,
  ...
  },
  {
    ...
    airline: 'TAP', airlineCode: 'TP', airlineLogo: 'https://pics.avs.io/120/120/TP.png',
    flightNumber: 'TP 82', durationMinutes: 810, stops: 1,
  ...
  },
  {
    ...
    airline: 'KLM', airlineCode: 'KL', airlineLogo: 'https://pics.avs.io/120/120/KL.png',
    flightNumber: 'KL 792', durationMinutes: 765, stops: 1,
  ...
  // === CDG → BRU (Paris → Bruxelas) ===
  {
    ...
    airline: 'Air France', airlineCode: 'AF', airlineLogo: 'https://pics.avs.io/120/120/AF.png',
    flightNumber: 'AF 3230', durationMinutes: 75, stops: 0,
  ...
  },
  {
    ...
    airline: 'Brussels Airlines', airlineCode: 'SN', airlineLogo: 'https://pics.avs.io/120/120/SN.png',
    flightNumber: 'SN 3622', durationMinutes: 70, stops: 0,
  ...
  },
  {
    ...
    airline: 'Air France', airlineCode: 'AF', airlineLogo: 'https://pics.avs.io/120/120/AF.png',
    flightNumber: 'AF 3238', durationMinutes: 75, stops: 0,
  ...
  // === BRU → GRU (Bruxelas → São Paulo — volta) ===
  {
    ...
    airline: 'Brussels Airlines', airlineCode: 'SN', airlineLogo: 'https://pics.avs.io/120/120/SN.png',
    flightNumber: 'SN 901', durationMinutes: 675, stops: 0,
  ...
  },
  {
    ...
    airline: 'TAP', airlineCode: 'TP', airlineLogo: 'https://pics.avs.io/120/120/TP.png',
    flightNumber: 'TP 645', durationMinutes: 795, stops: 1,
  ...
  },
  {
    ...
    airline: 'LATAM', airlineCode: 'LA', airlineLogo: 'https://pics.avs.io/120/120/LA.png',
    flightNumber: 'LA 8085', durationMinutes: 695, stops: 1,
...
export const MOCK_CAR_LOCATIONS: CarLocationOption[] = [
  { id: 'cl-01', name: 'Paris - Charles de Gaulle', label: 'Paris (CDG)', cityId: 'paris-cdg', latitude: 49.0097, longitude: 2.5479 },
  { id: 'cl-02', name: 'Paris - Orly', label: 'Paris (ORY)', cityId: 'paris-ory', latitude: 48.7262, longitude: 2.3652 },
  { id: 'cl-03', name: 'Paris - Gare du Nord', label: 'Paris — Gare du Nord', cityId: 'paris-gdn', latitude: 48.8809, longitude: 2.3553 },
  { id: 'cl-04', name: 'Bruxelas - Airport', label: 'Bruxelas (BRU)', cityId: 'bru-apt', latitude: 50.9014, longitude: 4.4844 },
  { id: 'cl-05', name: 'Bruxelas - Gare du Midi', label: 'Bruxelas — Gare du Midi', cityId: 'bru-midi', latitude: 50.8366, longitude: 4.3370 },
  { id: 'cl-06', name: 'São Paulo - Guarulhos', label: 'São Paulo (GRU)', cityId: 'sp-gru', latitude: -23.4356, longitude: -46.4731 },
];
